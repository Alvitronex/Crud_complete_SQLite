package com.example.crud_complete_sqlite;
...
//en la vista (Layout o xml) Personalizado. Este es el diseño personalizado para pintarcada registro en el recyclerview.
